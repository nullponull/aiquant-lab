...
# 集約 → PDCA + 週次レポート
/home/sol/.local/bin/uv run python ventures/patent_mine/aggregate_candidates.py
exec /home/sol/.local/bin/uv run python ventures/patent_mine/weekly_top_picks_v2.py
