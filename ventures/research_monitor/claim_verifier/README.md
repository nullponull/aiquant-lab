...
uv run python ventures/research_monitor/claim_verifier/process_inbox.py

# 全期間 process
uv run python ventures/research_monitor/claim_verifier/process_inbox.py --all

# 検証 (期限切れの claim だけ)
uv run python ventures/research_monitor/claim_verifier/verifier.py

# 週次レポート
uv run python ventures/research_monitor/claim_verifier/weekly_report.py --days 7
...
# DB 内容確認
sqlite3 /home/sol/aiquant-lab/ventures/research_monitor/data/claims/claims.db "SELECT * FROM claims LIMIT 10;"
```

## レポート出力先

- 週次レポート: `/home/sol/aiquant-lab/ventures/research_monitor/data/claims/reports/weekly_YYYY-MM-DD.md`
- DB: `/home/sol/aiquant-lab/ventures/research_monitor/data/claims/claims.db`
